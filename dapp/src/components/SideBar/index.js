  ...
  return (
    <SideBarContainer show={visible === true? '1': '0'} ref={thisInst}>
      ...
      <div className='footer-frame'>
        <MenuItem icon={<TwitterSVG width='28px' height='28px' />} link='https://twitter.com/Seed_Finance_' external small handleClick={() => handleClick(0)}/>
        <MenuItem icon={<TelegramSVG width='24px' height='24px' />} link='https://t.me/seedportal' external small handleClick={() => handleClick(0)}/>
      </div>
    </SideBarContainer>
  )
}
