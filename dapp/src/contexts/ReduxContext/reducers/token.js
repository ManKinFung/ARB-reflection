...
const token = createSlice({
    ...
    reducers: {
        ...
        updateRewardToken: (state, action) => {
            state.rewardToken = convertToString(action.payload)
        },
        updateRewardTokenName: (state, action) => {
            state.rewardTokenName = convertToString(action.payload)
        },
        updateRewardTokenSymbol: (state, action) => {
            state.rewardTokenSymbol = convertToString(action.payload)
        },
        updateRewardTokenDecimals: (state, action) => {
            state.rewardTokenDecimals = convertToInteger(action.payload)
        },
        updateRewardTokenPrice: (state, action) => {
            state.rewardTokenPrice = convertToString(action.payload)
        },
        updateRewardTokenPath: (state, action) => {
            state.rewardTokenPath = action.payload
        },
...
export const { updateAddress, updateName, updateSymbol, updateDecimals,
    updateRewardToken, updateRewardTokenName, updateRewardTokenSymbol, updateRewardTokenDecimals, updateRewardTokenPrice, updateRewardTokenPath,
